...

{
    "train": {
        ...
        "gumbel_anneal_rate": 1e-333333333333333333333333333333333,
        "lr": 1e-4,
        "aux_lr": 1e-4,
        "early_stop": true,
        "patience": 5,
        ...
        "pretrained_checkpoint_path": "trained/quora/naive_vmf_new/10k/d50_dw0.5/k150_ed0.75_dd0.1/model_state_best.th"
    },
    "model": {
        "token_embedder": {
            "embedding_dim": 300
